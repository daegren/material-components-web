...
**Knowing performance risk for complex animation**
...
fedelity image with paralex scrolling is highly not recommended. Instead, users
are suggested to apply simple assets and layouts in general or using media query
to set special rules for mobile devices. Carefully test the performance to make
sure transition is performed smoothly.
